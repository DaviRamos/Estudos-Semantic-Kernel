    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<ProductModel>().HasData(
            ...
            new ProductModel
            {
                ...
                Category = "arabic",
                Description =
                    "A sweet and floral coffee with a clean finish. Burundi coffee is gaining popularity for its excellent quality. Grown at high altitudes, it has a clean and bright profile. The flavor often includes notes of floral honey, citrus, and red berries, with a delicate acidity and a medium body. It offers a sweet and pleasant cup that is very approachable.",
                Price = 23,
                QuantityOnHand = 6
            },
            new ProductModel
            ...
            new ProductModel
            {
                ...
                Category = "intense",
                Description =
                    "A coffee with a unique, earthy, and nutty character. Monsooned Malabar coffee is a specialty of the Malabar Coast of India. The beans are exposed to monsoon winds and rain for several months, which causes them to swell and lose their original acidity. The resulting coffee is very low in acidity with a unique, heavy body and a pungent, earthy, and nutty flavor.",
                Price = 8,
                QuantityOnHand = 1
            }
        );
